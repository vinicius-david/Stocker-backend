...
var AddOrRemoveStockService_1 = __importDefault(require("../services/AddOrRemoveStockService"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        users = _a.sent();
                        return [2 /*return*/, res.json(users.map(function (user) { return (__assign(__assign({}, user), { password: null })); }))];
                }
            });
        });
    };
